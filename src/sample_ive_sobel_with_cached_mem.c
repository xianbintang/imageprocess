                                    ...
                                    HI_CHAR* pchSrcFileName, HI_U16 u16Width, HI_U16 u16Height)
{
    ...
    snprintf(achFileName, IVE_FILE_NAME_LEN, "./data/output/sobel/sobelh1.dat");
    ...
    snprintf(achFileName, IVE_FILE_NAME_LEN, "./data/output/sobel/sobelh2.dat");
    ...
    snprintf(achFileName, IVE_FILE_NAME_LEN, "./data/output/sobel/sobelv1.dat");
    ...
    snprintf(achFileName, IVE_FILE_NAME_LEN, "./data/output/sobel/sobelv2.dat");
...
void readYUV1(IVE_SRC_IMAGE_S *image, char *path) {
...
HI_VOID SAMPLE_IVE_Sobel1(char *path, SAMPLE_IVE_SOBEL_S * stSobel, int height, int width)
{
	IVE_SRC_IMAGE_S src;
		printf("hehe\n");
	SAMPLE_COMM_IVE_CreateImageByCached(&src, IVE_IMAGE_TYPE_U8C1, 320, 240);
	readYUV1(&src, "test1.yuv");
    HI_S32 s32Ret;
    //SAMPLE_IVE_SOBEL_S stSobel;
    HI_U16 u16Width = width;
    HI_U16 u16Height = height;
    HI_CHAR* pchSrcFileName = path;
